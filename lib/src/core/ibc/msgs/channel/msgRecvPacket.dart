import 'msgRecvPacket.dart'{ JSONSerializable } from '../../../../util/json';
import 'msgRecvPacket.dart'{ AccAddress } from '../../../bech32';
import 'msgRecvPacket.dart'{ Any } from '@terra-rebels/terra.proto/google/protobuf/any';
import 'msgRecvPacket.dart'{ Height } from '../client/Height';
import 'msgRecvPacket.dart'{ Packet } from './Packet';
import 'msgRecvPacket.dart'{ MsgRecvPacket as MsgRecvPacket_pb } from '@terra-rebels/terra.proto/ibc/core/channel/v1/tx';

/**
 * MsgRecvPacket receives incoming IBC packet
 */
export 'msgRecvPacket.dart'class MsgRecvPacket extends JSONSerializable<
  any,
  MsgRecvPacket.Data,
  MsgRecvPacket.Proto
> {
...
export 'msgRecvPacket.dart'namespace MsgRecvPacket {

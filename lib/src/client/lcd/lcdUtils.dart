import 'lcdUtils.dart'{ LCDClient } from './LCDClient';
import 'lcdUtils.dart'{ Coin } from '../../core/Coin';
import 'lcdUtils.dart'{ Int, Dec } from '../../core/numeric';
import 'lcdUtils.dart'{ Validator } from '../../core/staking/Validator';

abstract class ValidatorWithVotingPower {
  validatorInfo: Validator;
  votingPower: number;
  proposerPriority: number;
}

export 'lcdUtils.dart'class LCDUtils {

 class MultiSignature
    {
          LegacyAminoMultisigKey multisig_pubkey;

         CompactBitArray BitArray { get; set; }
         List<SignatureV2Descriptor> Signatures { get; set; }

         MultiSignature(LegacyAminoMultisigKey multisig_pubkey)
        {
